...
export class TodoResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => TodoList, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "TodoList",
    action: "read",
    possession: "any",
  })
  async todoList(@graphql.Parent() parent: Todo): Promise<TodoList | null> {
    const result = await this.service.getTodoList(parent.id);
